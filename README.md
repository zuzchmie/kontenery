...
5. **Wnioski**
  ...
  * z analizy parametrów dla main_solve.py:
    ...
    spowalniałby czas oczekiwania na wynik. Jeżeli chodzi natomiast o samą szerokość pudełek na wykresie, dla kształtów Wedge i Pentagon są one dość szerokie, co
    ...
    także od wielkości samej przestrzeni). Bazując na moich obserwacjach myślę, że możnaby postawić ostrożny wniosek, że współczynnik mutacji w okolicach ~0.3
